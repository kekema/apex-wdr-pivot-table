...
There are several vendors having Pivot Table component(s) in there portfolio, like [DevExpress](https://js.devexpress.com/jQuery/pivotgrid/), [Syncfusion](https://www.syncfusion.com/javascript-ui-controls/js-pivot-table), [Telerik](https://demos.telerik.com/kendo-ui/pivotgrid/index), [Infragistics](https://www.infragistics.com/products/ignite-ui-jquery/grids-and-lists/olap-pivot-grid), [Flexmonster](https://www.flexmonster.com/demos/js/pivot-table/), etc. In the Open Source domain, there is the [pivottable.js](https://pivottable.js.org/) component.
